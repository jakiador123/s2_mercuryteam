...
var cjs = function() {
  ...
  function filterData(href, rel) {
    ...
    if (args === '') {
	window.location = url + "?filter=" + encodeURIComponent(href.replace(location.protocol + '//' + location.hostname, ''));
    } else {
	...
	url = url + "?filter=" + encodeURIComponent(href.replace(location.protocol + '//' + location.hostname, '') + '?');
